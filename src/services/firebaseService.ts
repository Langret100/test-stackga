...
// Firebase 설정 — stackga 프로젝트와 동일한 DB를 재사용
// API 키는 Vite 환경변수(VITE_FIREBASE_API_KEY)에서 주입됩니다.
// .env.local 에 VITE_FIREBASE_API_KEY=실제키 를 추가하면 됩니다.
const FIREBASE_CONFIG = {
  apiKey: (typeof process !== 'undefined' && (process.env as any).VITE_FIREBASE_API_KEY)
    ? (process.env as any).VITE_FIREBASE_API_KEY
